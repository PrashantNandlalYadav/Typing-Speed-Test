...
JFrame confirmationFrame;
    ...
    public TypingTest() {
	 ...
	 button.addActionListener(this);
        ...
        button.setEnabled(true);  // Set to false initially
        ...
        label = new JLabel();
        label.setText("Typing Speed Test");
	...
	confirmationFrame = new JFrame("Confirmation");
        confirmationFrame.setSize(360, 150);
        confirmationFrame.setLayout(new FlowLayout());
        confirmationFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        confirmationFrame.setLocationRelativeTo(this);
	confirmationFrame.setBackground(new Color(173, 216, 230)); // Light Blue
	confirmationFrame.getContentPane().setBackground(new Color(173, 255, 153));


        JLabel confirmationLabel = new JLabel("Are you sure you want to play Typing Speed Test?");
        ...
        confirmationFrame.add(sureButton);
        confirmationFrame.add(backButton);
        confirmationFrame.setVisible(false); // Hide initially

        this.add(button, BorderLayout.SOUTH);
        this.add(label, BorderLayout.NORTH);
        getContentPane().setBackground(new Color(255, 204, 153)); // Light Orange
    ...
    public void actionPerformed(ActionEvent e) {
		...
		confirmationFrame.setVisible(true);
            // Disable the button when the test starts
            ...
            confirmationFrame.dispose(); // Close the confirmation frame
             // Call a method to start the typing test
