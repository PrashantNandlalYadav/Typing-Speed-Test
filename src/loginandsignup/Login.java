...
private boolean isValidEmail(String email) {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Typing Speed Test");
    ...
    try{
        ...
        if("".equals(email.getText())){
            ...
            JOptionPane.showMessageDialog(new JFrame(), "Invalid Email Address", "Error", JOptionPane.ERROR_MESSAGE);
            ...
            if(notFound ==1 && Password.equals(passDb)){
                // In Login Gui If Email And Password Is Correct Then What Will Happened
                dispose();
                MainGui.main(null); // Call the main method of TypingTest
